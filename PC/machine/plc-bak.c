	...
	while (g_exitThread == 0){
		...
		if  (g_updatePos){
			...
			else if(g_updatePosType == TANK_POS)
			{
				...
				{
					cnv._U32 = (int)sys->rtk[g_updatePosRTid].xUnlock2;
					Fmt (SwpSTR, "%s[a]<%i[r16w4p0]%i[r16w4p0]", cnv._U16[0],cnv._U16[1]);
				
					cnv._U32 = (int)sys->rtk[g_updatePosRTid].xLock2;
					Fmt (SwpSTR, "%s[a]<%i[r16w4p0]%i[r16w4p0]", cnv._U16[0],cnv._U16[1]);
				
					cnv._U32 = (int)sys->rtk[g_updatePosRTid].zDown2;
					Fmt (SwpSTR, "%s[a]<%i[r16w4p0]%i[r16w4p0]", cnv._U16[0],cnv._U16[1]);
				}
				else
				{
					cnv._U32 = (int)sys->rtk[g_updatePosRTid].xUnlock;
					Fmt (SwpSTR, "%s[a]<%i[r16w4p0]%i[r16w4p0]", cnv._U16[0],cnv._U16[1]);
				
					cnv._U32 = (int)sys->rtk[g_updatePosRTid].xLock;
					Fmt (SwpSTR, "%s[a]<%i[r16w4p0]%i[r16w4p0]", cnv._U16[0],cnv._U16[1]);
				
					cnv._U32 = (int)sys->rtk[g_updatePosRTid].zDown;
					Fmt (SwpSTR, "%s[a]<%i[r16w4p0]%i[r16w4p0]", cnv._U16[0],cnv._U16[1]);
				}
